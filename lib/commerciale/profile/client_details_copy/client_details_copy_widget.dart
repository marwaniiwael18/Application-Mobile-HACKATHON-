...
import 'client_details_copy_model.dart';
export 'client_details_copy_model.dart';

class ClientDetailsCopyWidget extends StatefulWidget {
  const ClientDetailsCopyWidget({
    super.key,
  ...
  @override
  State<ClientDetailsCopyWidget> createState() =>
      _ClientDetailsCopyWidgetState();
}

class _ClientDetailsCopyWidgetState extends State<ClientDetailsCopyWidget> {
  late ClientDetailsCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClientDetailsCopyModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<MarketRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final clientDetailsCopyMarketRecord = snapshot.data!;
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  context.pushNamed('ClientsAdminCopy');
                },
              ),
              title: Text(
                clientDetailsCopyMarketRecord.name,
              ...
              child: Padding(
                ...
                child: StreamBuilder<GouverneratRecord>(
                  stream: GouverneratRecord.getDocument(
                      clientDetailsCopyMarketRecord.gouvernerat!),
                  builder: (context, snapshot) {
                    // Customize what your widget looks like when it's loading.
                    if (!snapshot.hasData) {
                      return Center(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                clientDetailsCopyMarketRecord.adresse,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Inter',
