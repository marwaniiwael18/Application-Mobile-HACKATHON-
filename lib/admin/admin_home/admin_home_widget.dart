            ...
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(10.0, 12.0, 10.0, 12.0),
                    child: Row(
                      mainAxisSize: MainAxisSize.max,
                  ...
                  if (_model.textController.text != '')
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(0.0, 20.0, 0.0, 100.0),
                      child: StreamBuilder<List<RegionRecord>>(
                        stream: queryRegionRecord(
                          queryBuilder: (regionRecord) => regionRecord.where(
                            'name',
