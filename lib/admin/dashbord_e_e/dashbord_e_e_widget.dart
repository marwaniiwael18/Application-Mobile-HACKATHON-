...
import 'dashbord_e_e_model.dart';
export 'dashbord_e_e_model.dart';

class DashbordEEWidget extends StatefulWidget {
  const DashbordEEWidget({super.key});

  @override
  State<DashbordEEWidget> createState() => _DashbordEEWidgetState();
}

class _DashbordEEWidgetState extends State<DashbordEEWidget>
    with TickerProviderStateMixin {
  late DashbordEEModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashbordEEModel());
