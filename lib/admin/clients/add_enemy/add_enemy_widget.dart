...
import 'add_enemy_model.dart';
export 'add_enemy_model.dart';

class AddEnemyWidget extends StatefulWidget {
  const AddEnemyWidget({super.key});

  @override
  State<AddEnemyWidget> createState() => _AddEnemyWidgetState();
}

class _AddEnemyWidgetState extends State<AddEnemyWidget> {
  late AddEnemyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddEnemyModel());
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    await EnemiesRecord.collection
                        .doc()
                        .set(createEnemiesRecordData(
                      ...
                      builder: (context) {
                        return Padding(
                          ...
                          child: const SucessWidget(
                            message: 'Competitor added sucessfully',
                          ),
                        );
                      },
