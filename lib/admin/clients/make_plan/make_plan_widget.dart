...
import 'make_plan_model.dart';
export 'make_plan_model.dart';

class MakePlanWidget extends StatefulWidget {
  const MakePlanWidget({
    super.key,
    required this.date,
    required this.email,
    required this.user,
  ...
  @override
  State<MakePlanWidget> createState() => _MakePlanWidgetState();
}

class _MakePlanWidgetState extends State<MakePlanWidget> {
  late MakePlanModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MakePlanModel());
  }
